...
function DropdownMenuCheckboxItem({
  ...
  const checkbox = (
      <span
          className={cn('pointer-events-none absolute flex size-3.5 items-center justify-center', {
              'left-2': !alignCheckboxRight,
              'right-2': alignCheckboxRight,
          })}>
  ...
  return (
    (<DropdownMenuPrimitive.CheckboxItem
      ...
      className={cn(
        ...
        {
          'pr-2 pl-8': !alignCheckboxRight,
          'pr-8 pl-2': alignCheckboxRight,
        },
        className
      )}
      checked={checked}
      {...props}>
      {!alignCheckboxRight && checkbox}
      {children}
      {alignCheckboxRight && checkbox}
    </DropdownMenuPrimitive.CheckboxItem>)
  );
