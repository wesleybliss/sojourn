...
app.use('/api/:teamId/trips', routes.trips)
app.use('/api/:teamId/trips/:tripId/plans', routes.plans)
app.use('/api/:teamId/trips/:tripId/plans/:planId/segments', routes.segments)
app.use('/api/:teamId/places', routes.places)
