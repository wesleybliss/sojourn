...
```shell
$ git clone https://github.com/wesleybliss/trip-planner-basic app && cd $_
```

Run the setup script _(optional)_

- Replaces all instances of the title ("Trip Planner Basic")
- Replaces all instances of the slug ("trip-planner-basic")
